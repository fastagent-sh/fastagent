...
Note: your definition lives under `./agent/` relative to the workspace root — this file is `./agent/persona.md`, and a new skill goes to `./agent/skills/<name>/SKILL.md` (a `skills/` at the root is not scanned).
