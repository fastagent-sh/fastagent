...
| [Configuration and credential ownership](design/configuration.md) | Proposed: where each configuration fact lives, deployment environments, and who owns which credential |
