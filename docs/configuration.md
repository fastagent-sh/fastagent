...
Wherever `auth.json` lands, fastagent writes it `0600` and leaves its directory's permissions alone —
setting the mode of a file it creates is its business, changing a directory it did not create is not.
