...
Pure types under a future `@fastagent-sh/fastagent/session` subpath; the pi implementation lives
under `engines/pi/`. Exact TypeScript names may change during implementation; the boundary may not.
