...
// Send a message to a Feishu/Lark chat. In a CHAT turn the channel delivers the reply itself — this
...
const BASE = process.env.LARK_BASE_URL ?? "https://open.feishu.cn";
...
export default defineTool({
  description:
    "Send a message to a Feishu/Lark chat: plain `text`, or `markdown` (rendered as a card — headings, " +
